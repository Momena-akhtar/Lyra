 ...
 *     description: Retrieve a specific user's profile by UID (admin or own profile)
 ...
 *     description: Delete a user account (own account only)
 *     tags: [User Management]
 *     security:
 *       - BearerAuth: []
 *     parameters:
 ...
 *     description: Verify the validity of a Firebase ID token
 *     tags: [Authentication]
 *     requestBody:
 *       required: true
 *       content:
 ...
 *     description: Revoke all tokens for the current authenticated user
 *     tags: [Authentication]
 *     security:
 *       - BearerAuth: []
 *     responses:
